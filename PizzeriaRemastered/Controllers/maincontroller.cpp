...
void MainController::checkState(){
    ...
    case 0:
        ...
        break;
    case 1:
        cout << "Register a new pizza / topping / place "; //change or move if needed
        ...
        break;
    case 2:
        cout << "Make an order" << endl; //change or move if needed
        //make order for pizza, put some code here
        break;
    case 3:
        cout << "Enter your current work location"; //change or move if needed
        //bakari, pizza in progress/tilbúin
        cout << "Displayed pizzas";
        //þarf að vita stað og leita af þeim pizzum sem eru á þeim stað
        break;
    case 4:
        cout << "Your current location"; //change or move if needed
